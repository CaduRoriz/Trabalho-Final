...
const clientA = new proto.WordCounterService("localhost:50051", grpc.credentials.createInsecure(), grpcOptions);
const clientB = new proto.VowelCounterService("localhost:50052", grpc.credentials.createInsecure(), grpcOptions);
